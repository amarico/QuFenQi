...
function init()
{
    ...
    $("#button").click(function () {
        ...
        var bool = check_isnotNullById("textfield") &&
         check_isnotNullById("textfield2") &&
         check_isnotNullById("textfield3") &&
         check_isnotNullById("textfield7") &&
         check_isnotNullById("textfield4") &&
         check_isnotNullById("textfield5") &&
         check_isnotNullById("textfield6");

        if (bool == false) {
            window.alert("请将信息完善错误");
            return false;
        }
        else {
            window.alert("谢谢");
...
function check_isnotNullById(ID) {
    var str = $("#" + ID).val().trim();
    if (str != "") {
				...
				<form id="form1" name="form1" method="post"
					...
					<s:iterator value="customer" var="customer">
						<table width="368" align="center" border="1">
							<tr>
								<td height="35" align="center">修改用户</td>
							</tr>
							<tr>
								<td height="46" align="left">用户名：&nbsp; <input type="text"
									name="customer.userName" id="name"
									value="<s:property value="#customer.userName"/>" /></td>
							</tr>
							<tr>
								<td height="46" align="left"><label for="textfield2"></label>

									密码：&nbsp;&nbsp; <input type="text" name="customer.password"
									id="textfield2"
									value="<s:property value="#customer.password"/>" />
								</td>
							</tr>
							<tr>
								<td height="46" align="left"><label for="textfield3"></label>
									邮箱：&nbsp;&nbsp; <input type="text" name="customer.e_mail"
									id="textfield3" value="<s:property value="#customer.e_mail"/>" />
								</td>
							</tr>
							<tr>
								<td height="46" align="left">姓名：&nbsp;&nbsp; <input
									type="text" name="customer.name" id="textfield7"
									value="<s:property value="#customer.name"/>" /></td>
							</tr>
							<tr>
								<td height="46" align="left"><label for="textfield4"></label>
									省市：&nbsp;&nbsp;&nbsp;<select name="customer.province"
									id="province" size=1 onchange="getCity()"
									value="<s:property value="#customer.province"/>">
								...
								</select> <select id="city" style="width:60px" name="customer.city"
									value="<s:property value="#customer.city"/>">
								</select></td>
							</tr>
							<tr>
								<td height="46" align="left">详情地址： <label for="textfield4"></label>
									<input type="text" name="customer.address" id="textfield4"
									value="<s:property value="#customer.address"/>" />
								</td>
							</tr>
							<tr>
								<td height="46" align="left">信用额度： <label for="textfield5"></label>
									<input type="text" name="customer.creditLine" id="textfield5"
									value="<s:property value="#customer.creditLine"/>" />
								</td>
							</tr>
							<tr>
								<td height="46" align="left">账户余额： <label for="textfield6"></label>
									<input type="text" name="customer.money" id="textfield6"
									value="<s:property value="#customer.money"/>" />
								</td>
							</tr>
							<tr>
								<td height="73">&nbsp; &nbsp; &nbsp; <input type="submit"
									name="button" id="button" value="提交" /> &nbsp; &nbsp; <input
