...
<script>
	...
	function showMsg() {
		...
		xmlHttp.open("POST", "reportCost.action?proOrCity=" + x);
		// 设置操作的回调函数
					...
					<tr>
						<td width="958" height="35" align="center"><form id="form1"
								...
								<p>
									...
									</select> <input type="button" name="button2"
										style="width:100px; height:25px;" id="button2" value="查询"
										onclick="showMsg()" /> <input type="submit" name="button3"
										style="width:100px; height:25px;" id="button3"
										value="导出到excel" />
								</p>
								<p>&nbsp;</p>
							</form></td>
