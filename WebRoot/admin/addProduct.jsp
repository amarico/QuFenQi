				...
				<div id="qb">
					<form id="form1" name="form1" method="post"
						...
						<table width="536" border="1" align="center" cellpadding="0"
							cellspacing="0">
							<tr>
								<td height="40" colspan="2" align="center">增加商品</td>
							</tr>
							<tr>
								<td width="254" height="57">大&nbsp;&nbsp;&nbsp;&nbsp;类 <label
									for="textfield10"></label> <input type="text"
									name="typeAllName" id="textfield10" /></td>
								<td width="266">原&nbsp;&nbsp;&nbsp;&nbsp;价&nbsp;&nbsp;&nbsp;<label
									for="textfield9"></label> <input type="text"
									name="productInfo.originalPrice" id="textfield9" />
								</td>
							</tr>
							<tr>
								<td height="57">小&nbsp;&nbsp;&nbsp;&nbsp;类 <label
									for="textfield11"></label> <input type="text"
									name="typeDetailName" id="textfield11" />
								</td>
								<td>促&nbsp;销&nbsp;价&nbsp;&nbsp;&nbsp;<label
									for="textfield8"></label> <input type="text"
									name="productInfo.barginPrice" id="textfield8" /></td>
							</tr>
							<tr>
								<td height="57">商品名&nbsp;&nbsp;<label for="textfield"></label>
									<input type="text" name="productInfo.productName"
									id="textfield" />
								</td>
								<td>分&nbsp;期&nbsp;数 &nbsp;&nbsp;<label for="textfield8"></label>
									<input type="text" name="productInfo.monthNum" id="textfield8" />
								</td>
							</tr>
							<tr>
								<td height="57">品&nbsp;&nbsp;&nbsp;&nbsp;牌<label
							...
							<tr>
								<td height="57">数&nbsp;&nbsp;&nbsp;&nbsp;量<label
									for="textfield3"></label> <input type="text"
									name="productInfo.cu" id="textfield3" />
								</td>
								<td>颜&nbsp;&nbsp;&nbsp;&nbsp;色&nbsp;&nbsp;&nbsp;<label
									for="textfield11"></label> <input type="text"
									name="character.color" id="textfield11" /></td>
							</tr>
							<tr>
								<td height="57">类&nbsp;&nbsp;&nbsp;&nbsp;型<label
									for="textfield4"></label> <input type="text"
									name="character.type" id="textfield4" />
								</td>
								<td align="center"><input type="submit" name="button"
									id="button" value="提交" style="width:130px;"
