		...
		<div id="candan">
			...
			<div id="apDiv1">
				<form action="uploadAction.action" method="post"
					...
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						图片 <input type="file" id="dofile" name="file" /> &nbsp;&nbsp; 图片
						<input type="file" id="dofile" name="file" /> &nbsp; 图片<input
							type="file" id="dofile" name="file" />
					</p>
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						图片 <input type="file" id="dofile" name="file" /> &nbsp;&nbsp; 介绍
						<input type="file" id="dofile" name="file" /> &nbsp;介绍 <input
							type="file" id="dofile" name="file" />
					</p>
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						介绍 <input type="file" id="dofile" name="file" /> &nbsp;&nbsp; 介绍
						<input type="file" id="dofile" name="file" /> &nbsp;介绍 <input
							type="file" id="dofile" name="file" />
