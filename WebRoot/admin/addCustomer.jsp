...
<body onload="init()">
	<div id="all">
		<div id="head">
			<table width="100%" height="210px" background="../images/hahaha.jpg" border="0" rules="none" cellspacing="0" cellpadding="0">
				<tr>
					 <td colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/logo1.png" width="200" height="100" /></td>
					<td width="3%" rowspan="2"><img src="../images/u=1085408792,3256465306&fm=116&gp=0.jpg" width="32" height="24" /></td>
					 <td width="16%" rowspan="2"><a href="admin.jsp">admin</a>&nbsp;<a href="adminloginout.action">退出</a></td>
					 </tr>
		...
		<div id="candan">
			<div id="firstpane" class="menu_list">
				...
				<div style="display:none" class=menu_body>
					<a href="addProduct.jsp">增加商品</a> <a href="queryProduct.jsp">删除商品</a> <a
						href="queryProduct.jsp">修改商品</a> <a href="queryProduct.jsp">查看商品</a>
				</div>
			...
			<div id="apDiv1">
				<table width="368" align="center" border="1" cellpadding="0"
					cellspacing="0">
					<tr>
						<td height="35" align="center">增加用户</td>
					</tr>
					<tr>
						<td height="46" align="left">
							<form id="form1" name="form1" method="post"
								...
								用&nbsp;户&nbsp;名：&nbsp;&nbsp; &nbsp;<input type="text" name="customer.userName"
									id="textfield" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td height="46" align="left">详情地址：&nbsp; &nbsp;&nbsp;<input type="text"
							name="customer.address" id="textfield4" /></td>
					</tr>
					<tr>
						<td height="46" align="left">信用额度：&nbsp;&nbsp;&nbsp; <input type="text"
							name="customer.creditLine" id="textfield5" /></td>
					</tr>
					<tr>
						<td height="46" align="left">账户余额：&nbsp; &nbsp;&nbsp;<input type="text"
							name="customer.money" id="textfield6" /></td>
					</tr>
					<tr>
						<td height="73" align=center><input type="submit"
							name="button" id="button" value="提交" style="width:70px;" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
							type="reset" name="button2" id="button2" value="重置" style="width:70px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
							type="button" name="button3" id="button3" value="返回" style="width:70px;"/>
							</form></td>
					</tr>
				</table>
			</div>
