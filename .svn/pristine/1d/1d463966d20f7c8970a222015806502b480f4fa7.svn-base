				...
				<table width="1163" border="0">
					<tr>
						<td width="958" height="35" align="center"><form id="form1"
								name="form1" method="post" action="adminModifyPassword.action">
								<p>
									&nbsp;旧密码&nbsp;&nbsp;&nbsp;<input type="password"
										name="passwordOld" id="textfield" />
								</p>
								<p>
									&nbsp;新密码&nbsp;&nbsp;&nbsp;<input type="password"
										name="password" id="textfield" />
								</p>
								<p>
									再次确认&nbsp; <input type="password" name="passwordAgain"
										id="textfield2" />
								</p>
								<p>
									&nbsp; <input type="submit" name="button" id="button"
										value="确定" style="width:100px; height:30px;  " /> <input
										type="button" name="button2" id="button2" value="取消"
										style="width:100px; height:30px;  " onclick="window.close();" />
								</p>
								<p>&nbsp;</p>
							</form></td>
					</tr>
